    ...
    <section id={sectionIds.projects} className="mt-16 scroll-mt-24">
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-3">
        {c.projects.items.map((p, i) => (
          <Reveal key={p.title} reducedMotion={reducedMotion} delayMs={i * 80}>
            <article className="flex flex-col rounded-3xl border border-border bg-card/70 p-6 shadow-soft">
